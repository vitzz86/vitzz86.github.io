...
category: "Climate Venture Building"
reading_time: "10 min read"
summary: "What mentoring teams at the NomaTech Challenge for COP17 reinforced about turning climate ideas into credible pilots, defensible business models and evidence-led venture stories."
tags:
  - CLIMATE INNOVATION
  - VENTURE BUILDING
  - BUSINESS MODEL
...
NomaTech was developed in the wider context of UNCCD COP17 in Ulaanbaatar, Mongolia. The official conference takes place from 17 to 28 August 2026 under the theme “Restoring Land. Restoring Hope.”<sup class="citation"><a href="https://www.unccd.int/cop17" target="_blank" rel="noopener noreferrer" aria-label="Open source 1 in a new tab">1</a></sup> That context made the mentoring challenge especially relevant. Land, water and climate solutions cannot be judged by a polished prototype alone. They must work for people in a specific place and continue working after the initial demonstration.

<figure class="article-figure">
  <a href="/assets/notes/nomatech-cop17/nomatech-online-session.webp" target="_blank" rel="noopener"><img src="/assets/notes/nomatech-cop17/nomatech-online-session.webp" alt="Vito Christian Samudra presenting the NomaTech workshop to participants through an online session" width="1600" height="1200" loading="lazy" decoding="async"></a>
  <figcaption>Leading the online mentoring session for NomaTech Challenge participants.</figcaption>
</figure>
...
<figure class="article-figure">
  <a href="/assets/notes/nomatech-cop17/pilot-three-tests.webp" target="_blank" rel="noopener"><img src="/assets/notes/nomatech-cop17/pilot-three-tests.webp" alt="Three-part framework for testing whether a pilot is desirable, feasible and viable" width="2000" height="1125" loading="lazy" decoding="async"></a>
  <figcaption>A pilot becomes credible when desirability, feasibility and viability reinforce one another.</figcaption>
</figure>
...
<figure class="article-figure">
  <a href="/assets/notes/nomatech-cop17/evidence-assumption-test.webp" target="_blank" rel="noopener"><img src="/assets/notes/nomatech-cop17/evidence-assumption-test.webp" alt="Framework connecting evidence to an assumption and then to the next test" width="2000" height="1125" loading="lazy" decoding="async"></a>
  <figcaption>Evidence should lead to a clear assumption, then to a test that can change the team's decision.</figcaption>
</figure>
...
<figure class="article-figure">
  <a href="/assets/notes/nomatech-cop17/prototype-to-impact.webp" target="_blank" rel="noopener"><img src="/assets/notes/nomatech-cop17/prototype-to-impact.webp" alt="Impact pathway from prototype output to user behaviour change and local condition change" width="2000" height="1125" loading="lazy" decoding="async"></a>
  <figcaption>The prototype matters when it produces a measurable change beyond the product itself.</figcaption>
</figure>
...
This is also a better way to connect a venture to the Sustainable Development Goals. The United Nations framework contains 17 goals.<sup class="citation"><a href="https://sdgs.un.org/goals" target="_blank" rel="noopener noreferrer" aria-label="Open source 3 in a new tab">3</a></sup> A team should not begin by selecting the most attractive SDG badge. It should first define the local change and the indicator it can credibly observe. The relevant goal should follow from that logic.
...
<figure class="article-figure">
  <a href="/assets/notes/nomatech-cop17/bmc-to-numbers.webp" target="_blank" rel="noopener"><img src="/assets/notes/nomatech-cop17/bmc-to-numbers.webp" alt="Business Model Canvas assumptions translated into revenue and cost assumptions" width="2000" height="1125" loading="lazy" decoding="async"></a>
  <figcaption>Each commercial assumption in the canvas should have a numerical consequence.</figcaption>
</figure>
...
<figure class="article-figure">
  <a href="/assets/notes/nomatech-cop17/venture-story.webp" target="_blank" rel="noopener"><img src="/assets/notes/nomatech-cop17/venture-story.webp" alt="Venture story framework connecting problem, evidence, solution, pilot, impact, business model and ask" width="2000" height="1125" loading="lazy" decoding="async"></a>
  <figcaption>A strong pitch is a sequence of evidence and decisions, not a collection of impressive slides.</figcaption>
</figure>
...
<figure class="article-figure">
  <a href="/assets/notes/nomatech-cop17/ai-workshop.webp" target="_blank" rel="noopener"><img src="/assets/notes/nomatech-cop17/ai-workshop.webp" alt="Thirty-minute AI workshop divided into preparation, AI analysis and team review" width="2000" height="1125" loading="lazy" decoding="async"></a>
  <figcaption>The workshop placed the longest block of time on analysis, then protected time for human review and decisions.</figcaption>
</figure>
...
<figure class="article-figure article-figure--portrait">
  <a href="/assets/notes/nomatech-cop17/global-mentor-profile.webp" target="_blank" rel="noopener"><img src="/assets/notes/nomatech-cop17/global-mentor-profile.webp" alt="NomaTech Challenge profile announcing Vito Christian Samudra as a global mentor" width="1182" height="1576" loading="lazy" decoding="async"></a>
  <figcaption>NomaTech Challenge for COP17 introduced me as a global mentor supporting teams in refining their pitches and presenting them professionally.</figcaption>
</figure>
...
<ol class="source-list">
  <li id="source-1"><a class="source-number" href="https://www.unccd.int/cop17" target="_blank" rel="noopener noreferrer" aria-label="Open source 1 in a new tab">1</a><a href="https://www.unccd.int/cop17" target="_blank" rel="noopener noreferrer">United Nations Convention to Combat Desertification, “UNCCD COP17”</a>.</li>
  <li id="source-2"><a class="source-number" href="https://www.strategyzer.com/business-models-the-toolkit-to-design-a-disruptive-company" target="_blank" rel="noopener noreferrer" aria-label="Open source 2 in a new tab">2</a><a href="https://www.strategyzer.com/business-models-the-toolkit-to-design-a-disruptive-company" target="_blank" rel="noopener noreferrer">Strategyzer, “Business models: the toolkit to design a disruptive company”</a>.</li>
  <li id="source-3"><a class="source-number" href="https://sdgs.un.org/goals" target="_blank" rel="noopener noreferrer" aria-label="Open source 3 in a new tab">3</a><a href="https://sdgs.un.org/goals" target="_blank" rel="noopener noreferrer">United Nations Department of Economic and Social Affairs, “The 17 Goals”</a>.</li>
</ol>

</div>

<div class="article-author"><strong>About the author</strong>Vito Christian Samudra is a venture capitalist focused on technology, climate and energy-transition investments in Southeast Asia. He works across investment analysis, startup fundraising, portfolio development and venture-building systems. He also mentors early-stage teams on business models, investment readiness and evidence-led growth.</div>
