...
def _parsed(row: dict) -> dict | None:
    ...
    return {
        ...
        "analyst_target_low": _num(data.get("price_target_low")),
        "analyst_target_median": _num(data.get("price_target_median")),
        "analyst_target_high": _num(data.get("price_target_high")),
...
def price_map(rows: list[dict] | None = None) -> dict[str, dict]:
    ...
    for row in _parsed_rows(rows):
        ...
        prices[row["source_symbol"]] = {
            ...
            "analyst_target_low": row.get("analyst_target_low"),
            "analyst_target_median": row.get("analyst_target_median"),
            "analyst_target_high": row.get("analyst_target_high"),
