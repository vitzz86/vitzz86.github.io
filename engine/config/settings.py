...
IDX_INTRADAY_BATCH_LIMIT = 240       # rotate Yahoo 30m charts across IDX each 30-minute bake
IDX_INTRADAY_CACHE_HOURS = 3.0       # retain the latest successful session while refresh rotates
IDX_DAILY_HISTORY_LIMIT = 900        # true 6M closes for IDX risk/range; full-universe first pass
IDX_DAILY_HISTORY_CACHE_HOURS = 20   # refresh daily history at most once per market day
