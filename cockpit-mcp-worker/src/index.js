...
function createServer(env) {
  ...
  tool("get_macro_indicators", "Get source-linked official Indonesia macro releases, sovereign ratings, and market classifications with actual, prior-period, benchmark, and direction context. view accepts core, detail, or ratings.", { view: z.enum(["core", "detail", "ratings"]).optional(), pillar: optionalString }, ({ view, pillar }) => service.macroIndicators(view, pillar));
