...
function createServer(env) {
  ...
  tool("get_macro_indicators", "Get source-linked official Indonesia macro releases with actual, prior-period, benchmark, and direction context. view accepts core or detail.", { view: z.enum(["core", "detail"]).optional(), pillar: optionalString }, ({ view, pillar }) => service.macroIndicators(view, pillar));
